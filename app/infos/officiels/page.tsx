          ...
          <section className="mb-24 bg-slate-900 rounded-[40px] p-8 md:p-16 text-white shadow-2xl">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-black uppercase italic mb-4">L'équipe <span
                    className="text-red-600">Juge & Arbitre</span></h2>
          ...
          <section className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 border-l-4 border-red-600 p-8 shadow-sm rounded-r-3xl">
                <h3 className="font-black uppercase italic text-slate-900 mb-2 text-lg">Quel est son
                  rôle ?</h3>
                <p className="text-slate-600 leading-relaxed">Encadrer les concours et courses,
                  juger du respect des règles et faire respecter les règlements de la
                  fédération.</p>
              </div>
              <div className="bg-slate-50 border-l-4 border-red-600 p-8 shadow-sm rounded-r-3xl">
                <h3 className="font-black uppercase italic text-slate-900 mb-2 text-lg">Y a-t-il une
                  formation ?</h3>
                <p className="text-slate-600 leading-relaxed">Un syllabus succinct à assimiler, une
                  formation sur le terrain et un petit test de contrôle organisé fin mars.</p>
              </div>
            </div>
          </section>
        </main>
